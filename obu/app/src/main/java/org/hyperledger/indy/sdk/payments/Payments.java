...
public class Payments extends IndyJava.API {
     ...
     * @param paymentMethod com.example.myobu.Payment method to use (for example, 'sov')
     ...
     *
     * @param paymentMethod com.example.myobu.Payment method to use
     ...
     *
     * @param wallet    The wallet.
     * @param address:  com.example.myobu.Payment address of message signer. The key must be created by calling indy_create_address
     ...
     *
     * @param address   com.example.myobu.Payment address of the message signer
